...
const updateSheets = async (auth) => {
  ...
  console.log('removing old data', ClearResponse.statusText);
  const addRequest = {
    spreadsheetId: '1e4sRt9PckYL5bFbsFmiv-mM571slv3SHovP8UjQalJU',
    range: 'barley!A2',
  ...
  console.log('adding new data', addResponse.statusText);
};
exports.updateSheets = updateSheets;
